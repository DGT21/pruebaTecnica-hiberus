...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("")
            .version("v1.2")
            .contact(new Contact("","", "jmaranda@hiberus.com"))
            .build();
    }

    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.agendaDeContactos.base-path:/agenda}") String basePath) {
